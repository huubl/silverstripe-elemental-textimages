<%-- <p><code>FourBelow</code></p> --%>
	<div class="image-wrap image-wrap-below">
		<div class="row">
			<% loop $Me.Limit(4) %>
			<div class="col-xs-3 image-below">
                <a href="$Me.URL" class="lightbox" data-sub-html="$Legend.ATT" data-exthumbimage="$Me.Fill(96,76).Link">
                    <img width="360" height="360" class="img-responsive" src="$Me.FocusFill(360,360).URL" alt="$AltText.ATT" title="$TitleTag.ATT">
                </a>
